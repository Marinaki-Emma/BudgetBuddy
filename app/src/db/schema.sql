...
INSERT OR IGNORE INTO accounts (id, name, type, currency, starting_balance, is_archived, is_deleted, exclude_from_total, dirty, created_at, updated_at)
VALUES ('00000000-0000-4000-a000-000000000001', 'Salary', 'bank', 'EUR', 0, 0, 0, 0, 1, datetime('now'), datetime('now'));

INSERT OR IGNORE INTO accounts (id, name, type, currency, starting_balance, is_archived, is_deleted, exclude_from_total, dirty, created_at, updated_at)
VALUES ('00000000-0000-4000-a000-000000000002', 'Savings', 'savings', 'EUR', 0, 0, 0, 1, 1, datetime('now'), datetime('now'));